    ...
    for epoch in range(args.num_train_epochs):
        ...
        if accelerator.is_main_process:
            ...
            if (epoch) % 10 == 0:
                ...
                pipeline.to("cuda")
                images = []
                images.append(pipeline(prompt="Lego castle").images[0])
                images.append(pipeline(prompt="Yoda").images[0])
                images.append(pipeline(prompt="Forest during autumn").images[0])
                images.append(pipeline(prompt="Barack Obama").images[0])
